# Contributing to gke-realtime-rag-pipeline

## Project scope

GKE and Vertex AI RAG prototype. Cloud setup and corpus imports require explicit credentials and can incur cost. Static CI validates source syntax without importing cloud clients.
